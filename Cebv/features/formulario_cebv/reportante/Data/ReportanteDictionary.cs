...
public class ReportanteDictionary
{
    public static Dictionary<string, object?> GetReportante(Reportante reportante, Reporte reporte, ReportanteViewModel reportanteViewModel)
    {
        return new Dictionary<string, object?>
        {
            ...
            {"Nacionalidad", reportante.Persona.Nacionalidades[0]},
            ...
            {"No. Exterior", reportante.Persona.Direcciones[0]},
            {"No. Interior", reportante.Persona.Direcciones[0]},
            {"Colonia", reportante.Persona.Direcciones[0].Colonia},
            {"Código postal", reportante.Persona.Direcciones[0]},
            ...
            {"Religion", reportante.Persona.Religion},
            {"Estado conyugal", reportante.Persona.ContextoFamiliar?.NombreParejaConyugue}
        };
    }
}