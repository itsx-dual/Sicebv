...
{
    public static Dictionary<string, object?> GetReportante(Reportante reportante, Reporte reporte,
        ReportanteViewModel reportanteViewModel, Telefono telefonoMovil)

    {
        return new Dictionary<string, object?>
        {
            ...
            { "Telefono movil",  telefonoMovil.Numero},
            { "Observaciones movil", telefonoMovil.Observaciones},
