...
public class MediaFiliacionDictionary
{
    public static Dictionary<string, object?> GetMediaFiliacion(Desaparecido desaparecido)
    {
        return new Dictionary<string, object?>
        {
            ...
            {"Cualquier otra especificacion cabello", desaparecido.Persona.Cabello?.EspecificacionesCabello},
            {"Cejas", desaparecido.Persona.VelloFacial?.Cejas},
            {"Cualquier otra especificacion cejas", desaparecido.Persona.VelloFacial?.EspecificacionesCejas},
